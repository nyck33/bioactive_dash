...
class LactationElementsRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'LactationElementsRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
...
class LactationVitaminsRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'LactationVitaminsRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
    life_stage_grp = db_mongo.StringField(default="")
...
class LactationMacroRDI(NutrientsDocument):
    meta = {
        'collection': 'LactationMacroRDI'
    }
    life_stage_grp = db_mongo.StringField(default="")
...
class LactationElementsUpperRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'LactationElementsUpperRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
    life_stage_grp = db_mongo.StringField(default="")
    calcium = db_mongo.StringField(default='')  # m
...
class LactationVitaminsUpperRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'LactationVitaminsUpperRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
    life_stage_grp = db_mongo.StringField(default="")
