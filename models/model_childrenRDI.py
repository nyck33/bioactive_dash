...
class ChildrenElementsRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'ChildrenElementsRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
...
class ChildrenVitaminsRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'ChildrenVitaminsRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
    life_stage_grp = db_mongo.StringField(default="")
...
class ChildrenMacroRDI(NutrientsDocument):
    meta={
        'collection': 'ChildrenMacroRDI'
    }
    life_stage_grp = db_mongo.StringField(default="")
...
class ChildrenElementsUpperRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'ChildrenElementsUpperRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
    life_stage_grp = db_mongo.StringField(default="")
    calcium = db_mongo.StringField(default='')  # m
...
class ChildrenVitaminsUpperRDI(NutrientsDocument):
    """
    elements, vitamins, macro
    """
    meta = {
        'collection': 'ChildrenVitaminsUpperRDI'
    }
    # mg/d = m, ug/d = u, g/d = g
    life_stage_grp = db_mongo.StringField(default="")
